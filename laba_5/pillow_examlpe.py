...
im.save("new_bunny4.jpg")

# создание изображений
im = Image.new("RGB", (700, 700), (208, 240, 192))  # создание изображения
draw = ImageDraw.Draw(im)  # создаём холст поверх изображения

draw.ellipse((200, 150, 300, 350), fill=(255, 255, 255), outline=None, width=5)  # рисуем эллипс
draw.ellipse((400, 150, 500, 350), fill=(255, 255, 255), outline=None, width=5)  # рисуем эллипс

draw.ellipse((200, 300, 500, 550), fill=(255, 255, 255), outline=None, width=5)  # рисуем эллипс
...
draw.ellipse((290, 370, 320, 400), fill=(0, 191, 255), outline=None, width=5)  # рисуем эллипс
draw.ellipse((380, 370, 410, 400), fill=(0, 191, 255), outline=None, width=5)  # рисуем эллипс
